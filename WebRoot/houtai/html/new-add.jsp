						    ...
						    <div class="card alert">
						        <div class="card-body">
						            <div class="basic-form">
						                <form action="insertNewsByNoTupian" method="post">
											<h3>新闻添加（无图）</h3>
						                    <div class="form-group">
												<label class="col-sm-2 control-label">新闻标题</label>
						                        <input type="text" name="newstitle" class="form-control input-rounded" placeholder="新闻标题">
						                    </div>
											<div class="form-group">
												<label class="col-sm-2 control-label">新闻来源</label>
											    <input type="text" name="newslaiyuan" class="form-control input-rounded" placeholder="新闻来源">
											</div>
											<div class="form-group">
												<label class="col-sm-2 control-label">新闻作者</label>
											    <input type="text" name="newsauthor" class="form-control input-rounded" placeholder="新闻作者">
											</div>
											<div class="form-group">
												<label class="col-sm-2 control-label">责任编辑</label>
											    <input type="text" name="newszebian" class="form-control input-rounded" placeholder="责任编辑">
											</div>
											<div class="form-group">
												<label class="col-sm-2 control-label">新闻概括</label>
												<textarea name="news1" class="form-control" rows="3" placeholder="新闻概括"></textarea>
											</div>
											<div class="form-group">
												<label class="col-sm-2 control-label">新闻类型</label>
												<select name="newstype" class="form-control">
													<option value="时政要闻">时政要闻</option>
													<option value="国际新闻">国际新闻</option>
													<option value="国内新闻">国内新闻</option>
													<option value="港澳台新闻">港澳台新闻</option>
													<option value="深度关注">深度关注</option>
													<option value="热点追踪">热点追踪</option>
													<option value="来信照登">来信照登</option>
													<option value="无界视频">无界视频</option>
											...
											<div class="form-group">
												...
												<textarea id="editor_id" name="newsneirong" class="form-control" style="height: 400px;">
...
<script src="houtai/js/new-add.js" type="text/javascript" charset="utf-8"></script>
...
// 		var editor1 = K.create('textarea[name="newsneirong"]', {
// 			width: '80%',
// 			height: '400px',
// 			themeType:'simple',
// 			resizeType: 1, 
...
// 				self.sync();
// 				document.forms['newAddForm'].submit();
// 			});
