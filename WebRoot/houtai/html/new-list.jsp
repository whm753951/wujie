...
<body>
                ...
                <div class="main-content" id="box">
					...
					<!-- 列表 -->
                        <div class="col-lg-9">
                            <div class="card alert">
                                ...
                                <div class="card-body">
                                    <table class="table table-responsive table-hover ">
                                        ...
                                        <tbody>
                                            <tr v-for="(allnew,index) in allnews">
                                                
                                                <td>{{allnew.newstitle}}</td>
                                                <td>{{allnew.newstime}}</td>
                                                <td>{{allnew.newsauthor}}</td>
                                                <td>{{allnew.newslaiyuan}}</td>
												<td>{{allnew.newstype}}</td>
												<td>{{allnew.newstitle}}</td>
												<td>{{allnew.newszebian}}</td>
							...
							<div id="demo5" class="pagecss"></div>
						</div><!-- /# column -->
					</div><!-- /# row -->     </div>
	...
	<script src="houtai/js/new-list.js" type="text/javascript" charset="utf-8"></script>
