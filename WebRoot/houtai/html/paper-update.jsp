...
<body>
						            ...
						            <div class="basic-form">
						                <form>
						                    ...
						                    <div class="form-group">
												<label class="col-sm-2 control-label">期刊标题</label>
						                        <input type="text" class="form-control input-rounded" placeholder="期刊标题">
						                    </div>
	...
	<script src="houtai/js/paper-update.js" type="text/javascript" charset="utf-8"></script>
