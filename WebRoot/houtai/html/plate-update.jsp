...
<body>
						            ...
						            <div class="basic-form">
						                <form>
						                    ...
						                    <div class="form-group">
												<label class="col-sm-2 control-label">杂志标题</label>
						                        <input type="text" class="form-control input-rounded" placeholder="杂志标题">
						                    </div>
											<div class="form-group">
												<label class="col-sm-2 control-label">杂志图片</label>
	...
	<script src="houtai/js/new-update.js" type="text/javascript" charset="utf-8"></script>
