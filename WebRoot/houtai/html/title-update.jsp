...
<body>
						            ...
						            <div class="basic-form">
						                <form>
						                    ...
						                    <div class="form-group">
												<label class="col-sm-2 control-label">友情链接标题</label>
						                        <input type="text" class="form-control input-rounded" placeholder="人员名称">
						                    </div>
											<div class="form-group">
												<label class="col-sm-2 control-label">友情链接地址</label>
											    <input type="text" class="form-control input-rounded" placeholder="人员编号">
											</div>
											<div class="form-group">
												<label class="col-sm-2 control-label">友情链接类型</label>
	...
	<script src="houtai/js/title-update.js" type="text/javascript" charset="utf-8"></script>
